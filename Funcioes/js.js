...
//Septimo Ejercicio
/*
var temperatura = prompt("Digite la tempera a Convertir: ");

function TemperaCelsius(tem){

    var f = (tem * 1.8) + parseInt (32);
...
var fechasemanas = semanas(DiaActual);
